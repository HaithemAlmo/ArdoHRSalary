...
namespace Almotkaml.HR.Models
{
    ...
    {
        [Display(ResourceType = typeof(Title),Name = nameof(Title.SitionsNew))]
       ...
       public string OldJobNumber { get; set; }
        ...
        [Display(ResourceType = typeof(Title),Name = nameof(Title.DirectlyDate))]
        public string DirectlyDate { get; set; } // تاريخ المباشرة    

        [RegularExpression(@"^[0-9]*$", ErrorMessage = "الرجاء إدخال ارقام فقط")]
        [MaxLength(14, ErrorMessageResourceType = typeof(ValidationMessages), ErrorMessageResourceName = nameof(ValidationMessages.Degree))]
        ...
        [Date]
        [Display(ResourceType = typeof(Title),Name = nameof(Title.DateDegreeNow))]
        ...
        [Date]
        [Display(ResourceType = typeof(Title),Name = nameof(Title.DateMeritDegreeNow))]
        ...
        [Date]
        [Display(ResourceType = typeof(Title),Name = nameof(Title.DateBouns))]
        public string DateBouns { get; set; } // تاريخ العلاوة

        [Date]
        [Display(ResourceType = typeof(Title),Name = nameof(Title.DateMeritBouns))]
        ...
        [RegularExpression(@"^[0-9]*$", ErrorMessage = "الرجاء إدخال ارقام فقط")]
        [Display(ResourceType = typeof(Title),Name = nameof(Title.SerialNumber))]
        ...
        public IEnumerable<AdjectiveEmployeeListItem> AdjectiveEmployeeList { get; set; } = new HashSet<AdjectiveEmployeeListItem>();
        public IEnumerable<AdjectiveEmployeeTypeListItem> AdjectiveEmployeeTypeList { get; set; } = new HashSet<AdjectiveEmployeeTypeListItem>();
        public IEnumerable<CenterListItem> CenterList { get; set; } = new HashSet<CenterListItem>();
        public IEnumerable<ClassificationOnSearchingListItem> ClassificationOnSearchingList { get; set; } = new HashSet<ClassificationOnSearchingListItem>();
        public IEnumerable<ClassificationOnWorkListItem> ClassificationOnWorkList { get; set; } = new HashSet<ClassificationOnWorkListItem>();
